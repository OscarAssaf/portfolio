export const site = {
  ...
  email: "asos.oscar@hotmail.com",
  github: "https://github.com/oscarassaf",
  ...
  highlights: [
    ...
    "Built functional applications with real-time features and API integrations",
    "Solid foundation in system programming, mobile, and web development",
  ],
};
